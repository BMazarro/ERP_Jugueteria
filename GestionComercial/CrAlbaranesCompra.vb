...
Public Class CrAlbaranesCompra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestionComercial.CrAlbaranesCompra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrAlbaranesCompra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrAlbaranesCompra = New CrAlbaranesCompra()
        rpt.Site = Me.Site
        Return rpt
    End Function
